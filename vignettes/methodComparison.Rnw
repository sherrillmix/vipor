...
We plot the data using quasirandom, pseudorandom, alternating, Tukey texture and beeswarm methods:% (Figure \ref{figVpPlot}):
...
<<vpCounties, echo=TRUE, eval=FALSE>>=
...
@
\begin{center}
<<showCounties, fig=TRUE, height=5, width=8, echo=FALSE>>=
<<vpCounties>>
@
\end{center}
...
@
\begin{center}
<<showInts, fig=TRUE, height=8, width=5, echo=FALSE>>=
<<vpInts>>
@
\end{center}
